# CANONICAL RUN  GOS-FC

This repository contains a deterministic forensic compiler.

The primary evidence of its behavior is **the compiled output**, not the documentation.

If you read only one artifact, read the failure report below.
...
The compiler **fails intentionally and deterministically**.
